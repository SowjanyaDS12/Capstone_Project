...
app = Flask(__name__)
model = pickle.load(open('sentiment-xg-boost-model.pkl', 'rb'))
tf=pickle.load(open('tfidf-vectorizer.pkl','rb'))
FinalRating=pickle.load(open('user_final_rating.pkl','rb'))
recommend_train=pickle.load(open('cleaned-data.pkl','rb'))
